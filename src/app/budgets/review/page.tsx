    ...
    <div className="min-h-screen bg-white">
      ...
      <main className="mx-auto w-full max-w-[1440px] px-5 pb-14 pt-10 sm:px-12">
        <div className="flex flex-col justify-between gap-5 sm:flex-row sm:items-end">
          <div><p className="text-[11px] font-semibold uppercase tracking-[0.14em] text-finance-blue">월말 계획</p><h1 className="mt-2 text-[30px] font-bold leading-none tracking-[-0.03em] text-finance-ink">월말 리뷰</h1><p className="mt-2 t-caption text-finance-muted">{data.reviewMonth} 결산 → {data.targetMonth} 예산 만들기</p></div>
