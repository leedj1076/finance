    ...
    <div className="min-h-screen bg-white">
      ...
      <main className="mx-auto w-full max-w-[1440px] px-5 pb-14 pt-10 sm:px-12">
        ...
        <div>
          ...
          <p className="mt-2 text-xs text-finance-muted">매월 반복되는 수입·지출·저축의 규칙을 관리합니다. 월 반영은 거래 화면에서 실행합니다.</p>
        </div>
        ...
        <p className="mt-5 border-l-2 border-finance-blue bg-finance-blue-tint px-3 py-3 text-xs leading-5 text-finance-blue">
