        ...
        <div className="grid gap-8 lg:grid-cols-[200px_minmax(0,1fr)]">
          ...
          <div className="min-w-0">
            ...
            {section === 'assets' && assetData && (
              <>
                {params.saved === '1' && <p className="mt-5 border-l-2 border-finance-green bg-finance-green-tint px-4 py-3 t-body text-finance-green">자산 계정 변경사항을 저장했습니다.</p>}
            ...
            {section === 'security' && (
              <section className="mt-6 max-w-xl border-t border-finance-ink pt-6">
                {params.passwordChanged === '1' && <p className="mb-5 border-l-2 border-finance-green bg-finance-green-tint px-4 py-3 t-body text-finance-green">비밀번호를 변경했습니다.</p>}
                <h2 className="t-section text-finance-ink">비밀번호 변경</h2>
                <PasswordChangeForm />
              </section>
            )}
          </div>
