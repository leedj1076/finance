  ...
  test('the page passes canonical actuals and historical saved reasons into one budget editor', async () => {
    ...
    loaders.budget.mockResolvedValue({
      ...
      planRows: [{
        ...
        trend: [
          { month: '2026-06', amount: 290_000, closed: true, revision: 1 },
          { month: '2026-07', amount: 290_000, closed: true, revision: 1 },
          { month: '2026-08', amount: 320_000, closed: true, revision: 1 },
        ],
      }],
